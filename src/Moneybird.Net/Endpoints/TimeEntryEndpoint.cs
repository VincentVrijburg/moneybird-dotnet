...
namespace Moneybird.Net.Endpoints
{
    public class TimeEntryEndpoint : ITimeEntryEndpoint
    {
        ...
        public async Task<IEnumerable<TimeEntry>> GetAsync(string administrationId, string accessToken)
        {
        ...
        public async Task<IEnumerable<TimeEntry>> GetAsync(string administrationId, string accessToken, TimeEntryFilterOptions options)
        {
