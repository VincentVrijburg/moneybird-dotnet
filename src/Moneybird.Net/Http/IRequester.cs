...
namespace Moneybird.Net.Http
{
    public interface IRequester : IDisposable
    {
        ...
        /// <summary>
        /// Create a request for a generated download and send it asynchronously to the Moneybird api.
        /// </summary>
        /// <param name="host">The host.</param>
        /// <param name="relativeUrl">The relative url.</param>
        /// <param name="accessToken">The access token.</param>
        /// <param name="method">The HTTP method to use (typically <see cref="HttpMethod.Get"/> or <see cref="HttpMethod.Post"/>).</param>
        /// <param name="queryParameters">The query parameters.</param>
        ...
        /// Contains the Http error code and error message.
        /// </exception>
        Task<Stream> CreateDownloadRequestAsync(string host, string relativeUrl, string accessToken, HttpMethod method, List<string> queryParameters = null);
